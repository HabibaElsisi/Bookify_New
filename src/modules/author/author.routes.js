...
import { addAuthor, deleteAuthor, getAllAuthors, getAllAuthorsToSelect, getSingleAuthor, updateAuthors } from "./author.controller.js"
...
authorRouter.route("/")
    ...
    .get(getAllAuthors)
authorRouter.get("/selectAuthor",getAllAuthorsToSelect)
