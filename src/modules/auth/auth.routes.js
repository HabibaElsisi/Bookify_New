...
import { changePassword, deleteAccount, forgetPassword, getInfo, logout, resetPassword, signUp, signin, updateInfo, updateStatus, verify } from "./auth.controller.js"
...
authRouter.get("/getInfo",protectedRoutes,allowedTo("user"),getInfo)
